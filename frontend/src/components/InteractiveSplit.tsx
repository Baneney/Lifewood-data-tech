...
//   return (
//     <section className="relative min-h-screen md:h-[85vh] flex flex-col md:flex-row overflow-hidden bg-[#f0f7f3] dark:bg-[#021a11] border-y border-[#034E34]/10 dark:border-white/5">
...
//               />
//               <div className="absolute inset-0 bg-linear-to-b md:bg-linear-to-r from-transparent via-transparent to-[#f0f7f3]/80 dark:to-[#021a11]/80" />
//             </div>
...
//                   >
//                     <h2 className="text-3xl md:text-6xl font-black uppercase tracking-tighter leading-[0.9] text-[#034E34] dark:text-white">
//                       {item.headline.split(' ').map((word, i) => (
//                         <span key={i} className="block">{word}</span>
//                       ))}
//                     </h2>
//                     <p className="text-[#034E34]/70 dark:text-gray-300 text-xs md:text-base mt-4 md:mt-6 max-w-md leading-relaxed">
//                       {item.desc}
//                     </p>
//                   </motion.div>
//                 )}
