...
//           {/* Main Glass Card */}
//           <div className="bg-white/3 w-[90%] backdrop-blur-3xl rounded-[2.5rem] border border-white/10 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.6)] overflow-hidden">
//             <AnimatePresence>
//               {isSubmitting && (
...
//                       isActive ? "bg-white/2" : "opacity-30"
//                     }`}
//                   >
//                     <span
