...
//             Contact Us
//           </p>
//           <h1 className="text-6xl md:text-8xl font-black leading-[0.85] tracking-tighter uppercase overflow-visible">            Let's Talk            <br />            <span className="block overflow-visible">              <RotatingText                texts={["About You.", "About Work.", "About Growth.", "About Life."]}                mainClassName="inline-flex overflow-visible"                splitLevelClassName="overflow-visible"                elementLevelClassName="contact-outline-text"                staggerDuration={0.03}                staggerFrom="first"                rotationInterval={3000}              />            </span>          </h1>
//         </div>
...
//   return (
//     <section className="min-h-screen pt-28 pb-20 text-white selection:bg-[#FFB347] selection:text-[#034E34]" style={{ backgroundColor: "var(--site-bg)" }}>
//       <style
