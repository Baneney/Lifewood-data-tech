...
function SidebarNav() {
  ...
  return (
    <>
      ...
      {/* Main Nav */}
      <SidebarContent className="px-0 py-6" style={{ backgroundColor: "var(--admin-sidebar)" }}>
      ...
      {/* Footer */}
      <SidebarFooter className="p-0 border-t border-white/5" style={{ backgroundColor: "var(--admin-sidebar-foot)" }}>
