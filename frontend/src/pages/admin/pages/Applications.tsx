...
// const columns: ColumnDef<ApplicationDataType>[] = [
...
const columns: ColumnDef<ApplicationDataType>[] = [
  ...
  {
    accessorKey: "position.title", // Accessing position -> title
    header: "Role",
  },
  {
  ...
  {
    accessorKey: "position.status", // Accessing position -> status
    header: "Status",
    cell: ({ row }) => {
      const status = row.original.position.status;
      return (
